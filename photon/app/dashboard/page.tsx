...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto py-6 sm:px-6 lg:px-12 xl:px-16">
        <div className="px-4 py-6 sm:px-0">
          ...
          {/* Main Layout: Habits on left, Calendar & Goals on right */}
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            {/* Habits List - Left sidebar, spans full height on large screens */}
            <div className="lg:col-span-1 order-2 lg:order-1">
              {habitsLoading ? (
                <div className="bg-white rounded-xl shadow-md border border-gray-200 flex justify-center items-center py-12 sticky top-6">
            ...
            {/* Right content: Calendar and Goals */}
            <div className="lg:col-span-4 space-y-6 order-1 lg:order-2">
              {/* Weekly Tasks Calendar Section */}
              <div>
                <div className="mb-4">
